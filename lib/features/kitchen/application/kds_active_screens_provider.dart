...
/// layer) so that `KdsScreenManagementController.createScreen` and
/// `updateScreen` (also application layer) can invalidate it without a
/// presentation->application import direction violation.
